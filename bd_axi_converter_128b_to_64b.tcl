...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
Enjoy-Digital.com:user:AXIConverter:1.3\
...
proc create_root_design { parentCell } {
  ...
  set axi_converter_128b_t_0 [ create_bd_cell -type ip -vlnv Enjoy-Digital.com:user:AXIConverter:1.3 axi_converter_128b_t_0 ]
