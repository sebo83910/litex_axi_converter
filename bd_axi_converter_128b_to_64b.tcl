...
################################################################
# This is a generated script based on design: axi_converter_128b_to_64b
#
...
# source axi_converter_128b_to_64b_script.tcl
...
set design_name axi_converter_128b_to_64b
...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
Enjoy-Digital.com:user:axi_converter_128b_to_64b:1.3\
...
proc create_root_design { parentCell } {
  ...
  set wishbone_in [ create_bd_intf_port -mode Slave -vlnv Enjoy-Digital.com:interface:wishbone_rtl:1.0 wishbone_in ]
  ...
  set axi_converter_128b_t_0 [ create_bd_cell -type ip -vlnv Enjoy-Digital.com:user:axi_converter_128b_to_64b:1.3 axi_converter_128b_t_0 ]
  ...
  connect_bd_intf_net -intf_net wishbone_in_0_1 [get_bd_intf_ports wishbone_in] [get_bd_intf_pins axi_converter_128b_t_0/wishbone_in]
